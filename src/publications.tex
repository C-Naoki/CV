...
\begin{EntriesTablePublications}
  ...
  \textbf{AdaKoop: Efficient Modeling of Nonlinear Dynamics from Nonstationary Data Streams with Koopman Operator Regression}.
  Proceedings of the 32nd ACM SIGKDD Conference on Knowledge Discovery and Data Mining (\textbf{KDD'26}), Jeju, Korea, August 9-13, 2026. Acceptance rate: 18.5\%. \DOI{10.1145/3770855.3817851}.
  \newline
  \hspace*{-0.12em}
  \GitHub{C-Naoki/AdaKoop}
  \\

  [C2] &
  \Me, \TOka, \YMatsubara, \YSakurai, and \SYasui.
  \textbf{Modeling Covariate Transition for Efficient Estimation of Longitudinal Treatment Effects in Randomized Experiments}.
  Proceedings of the 43rd International Conference on Machine Learning (\textbf{ICML'26}), Seoul, South Korea, July 6-11, 2026. Acceptance rate: 26.6\%. \URL{to appear}.
  \newline
  \hspace*{-0.12em}
  \GitHub{C-Naoki/dynamic-adjustment}
  \\

  [J3] &
  \Me, \YMatsubara, \RFujiwara, and \YSakurai.
  \textbf{Modeling Time-evolving Causality and Forecasting in Data Streams}.
  IPSJ Transactions on Databases (TOD), Vol. 19, No. 2, pp. 70-81, April 21, 2026. \URL{https://ipsj.ixsq.nii.ac.jp/records/2009109}.
  \newline
  \textcolor{mediumred}{\textsb{DEIM Recommended Paper.}}
  \\
